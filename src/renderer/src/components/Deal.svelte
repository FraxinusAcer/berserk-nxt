  ...
  <aside class="right">
    <section>
      ...
      <div style="display: flex; justify-content: space-between; width: 100%; margin-top: 10px;">
        ...
        <button class="outline" style="padding: 5px; height: 45px;  margin-left: 10px;" on:click={(e) => { takeScreenshot('.content .field', deckName, null, " (отряд)", e.shiftKey, $other_options['screenshot_size']) }}>
