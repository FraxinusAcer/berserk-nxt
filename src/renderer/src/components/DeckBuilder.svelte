...
<aside class="right">
  <section>
    ...
    {#if userDeck.length < 30 && hasPredict}
    ...
    <div style="display: flex; justify-content: space-between; width: 100%; margin-top: 10px;">
      ...
      <button class="outline" style="padding: 5px; height: 45px;  margin-left: 10px;" on:click={(e) => { takeScreenshot('#deck-view', deckName, groupCards($user_decks['decks'][deck_id].cards, show_full ? 'asis' : order), "", e.shiftKey) }}>
